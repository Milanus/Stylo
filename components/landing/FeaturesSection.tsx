...
export default function FeaturesSection() {
  ...
  const { types: transformationTypes, isLoading } = useTransformationTypes()
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {isLoading ? (
            ...
            transformationTypes.slice(0, 6).map((feature) => {
              ...
              const colors = colorMap[feature.slug] || colorMap.grammar
                ...
                >
                  <div className="p-6 space-y-3">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white">
                      {tTransformations(`${feature.slug}.label`)}
                    </h3>
                    <p className="text-slate-600 dark:text-slate-400">
                      {tTransformations(`${feature.slug}.description`)}
                    </p>
                  </div>
                </Card>
              )
